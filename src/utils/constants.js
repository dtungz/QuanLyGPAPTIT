...
export const DEFAULT_GRADE_SCALES = [
  {
    ...
    scale: [
      ...
      { letter: 'A', minScore: 8.5, maxScore: 8.99, gpa4: 3.7, classification: 'Giỏi' },
      { letter: 'B+', minScore: 8.0, maxScore: 8.49, gpa4: 3.5, classification: 'Giỏi' },
      { letter: 'B', minScore: 7.0, maxScore: 7.99, gpa4: 3.0, classification: 'Khá' },
      { letter: 'C+', minScore: 6.5, maxScore: 6.99, gpa4: 2.5, classification: 'Khá' },
      { letter: 'C', minScore: 5.5, maxScore: 6.49, gpa4: 2.0, classification: 'Trung bình' },
      { letter: 'D+', minScore: 5.0, maxScore: 5.49, gpa4: 1.5, classification: 'Trung bình' },
      { letter: 'D', minScore: 4.0, maxScore: 4.99, gpa4: 1.0, classification: 'Yếu' },
